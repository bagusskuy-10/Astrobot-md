        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 0) {
                    this.reply(m.chat, `[❗] Limit anda habis, silahkan beli melalui *${usedPrefix}buy limit*\natau kamu bisa ketik *.claim* untuk mendapatkan secara gratis`, m)
                    ...
                    this.sendMessage(id, {
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                ...
                                body: action == 'add' ? 'EH ADA MEMBER YANG JOIN :)' : 'BYE BEBAN! :)',
                                mediaType: 1,
                                previewType: "PHOTO",
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: '🛑 *AKSES DITOLAK* Kamu belum terdaftar di database kami Slakan daftar dengan mengetik *.daftar* ',
